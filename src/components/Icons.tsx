...
export function BrushIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 3a9 9 0 1 0 9 9c0-.6-.06-1.16-.18-1.72a2 2 0 0 0-2.47-1.5l-1.16.31a2 2 0 0 1-2.45-1.93V6.5A3.5 3.5 0 0 0 11.25 3z" />
...
export function SparkIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 2l2.4 7.4L22 12l-7.6 2.6L12 22l-2.4-7.4L2 12l7.6-2.6L12 2z" fill="currentColor" fillOpacity="0.2" />
...
export function BrainIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z" fillOpacity="0.1" fill="currentColor" />
...
export function EraserIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function TelegramIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.248l-2.04 9.612c-.15.67-.543.834-1.098.518l-3.042-2.24-1.468 1.412c-.162.162-.298.298-.61.298l.217-3.09 5.608-5.066c.244-.217-.053-.337-.377-.12L7.08 14.13l-2.99-.934c-.65-.204-.663-.65.135-.963l11.68-4.502c.54-.195 1.013.132.657.517z" />
    </svg>
  );
}
...
export function FolderOpenIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function ThinkIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M9 18h6" />
      <path d="M10 21h4" />
      <path d="M12 3v1.5" />
      <path d="M6 7l1.1 1.1" />
      <path d="M18 7l-1.1 1.1" />
      <path d="M4 12h1.5" />
      <path d="M18.5 12H20" />
      <path d="M8.5 11.5a3.5 3.5 0 1 1 7 0c0 1.3-.56 2.12-1.18 2.88c-.53.65-1.07 1.28-1.07 2.12v.5h-2.5v-.5c0-.84-.54-1.47-1.07-2.12c-.62-.76-1.18-1.58-1.18-2.88Z" />
      <path d="M10 11.5c.33-.72 1.03-1.2 2-1.2c.76 0 1.34.25 1.76.73" />
    </svg>
  );
}
...
export function RepeatIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
