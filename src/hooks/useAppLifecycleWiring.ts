...
export function useAppLifecycleWiring(options: UseAppLifecycleWiringOptions) {
  ...
  useAppSettingsLoad({
    ...
    setMediaPlayerPanelOpen: options.setMediaPlayerPanelOpen,
    ...
    setUserAutoPilot: options.setUserAutoPilot,
  ...
  useAppSettingsSave({
    ...
    mediaPlayerPanelOpen: options.mediaPlayerPanelOpen,
    ...
    userAutoPilot: options.userAutoPilot,
